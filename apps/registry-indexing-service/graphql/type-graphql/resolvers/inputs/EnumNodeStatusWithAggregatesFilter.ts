...
import { NestedEnumNodeStatusWithAggregatesFilter } from "../inputs/NestedEnumNodeStatusWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { NodeStatus } from "../../enums/NodeStatus";

@TypeGraphQL.InputType("EnumNodeStatusWithAggregatesFilter", {
  isAbstract: true
})
export class EnumNodeStatusWithAggregatesFilter {
